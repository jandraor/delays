...
caption <- str_glue("Fig {fig_cntr}. Scenario 2's simulated incidence reports. Measurement noise from the Poisson (no overdispersion) & Negative Binomial distributions was added to the smooth trajectories obtained from SEIR instances with an exponential-distributed latent period.")
```
...
```{r}
table_coverage(coverage_df, "Table 2. Scenario 2's coverage table. Poisson noise")
```
...
```{r}
table_coverage(coverage_df, "Table 3. Scenario 2's coverage table. Overdispersion")
```
...
caption  <- str_glue("Fig {fig_cntr}. Scenario 3's simulated incidence reports. Measurement noise from the Poisson (no overdispersion) & Negative Binomial distributions was added to the smooth trajectories obtained from SEIR instances with an exponential-distributed latent period.")
```
...
```{r}
table_coverage(coverage_df, "Table 4. Scenario 3's coverage table. Poisson noise")
```
...
```{r}
table_coverage(coverage_df, "Table 5. Scenario 3's coverage table. Overdispersion")
```
...
caption  <- str_glue("Fig {fig_cntr}. Scenario 4's simulated incidence reports. Measurement noise from the Poisson (no overdispersion) & Negative Binomial distributions was added to the smooth trajectories obtained from SEIR instances with an exponential-distributed latent period.")
```
...
```{r S4_pois_cov}
table_coverage(coverage_df, "Table 6. Scenario 4's coverage table. Poisson noise")
```
...
```{r}
table_coverage(coverage_df, "Table 7. Scenario 4's coverage table. Overdispersion")
```
...
caption  <- str_glue("Fig {fig_cntr}. Scenario 5's simulated incidence reports. Measurement noise from the Poisson (no overdispersion) & Negative Binomial distributions was added to the smooth trajectories obtained from SEIR instances with an exponential-distributed latent period.")
```
...
```{r}
table_coverage(coverage_df, "Table 8. Scenario 5's coverage table. Poisson")
```
...
```{r}
table_coverage(coverage_df, "Table 9. Scenario 5's coverage table. Overdispersion")
```
