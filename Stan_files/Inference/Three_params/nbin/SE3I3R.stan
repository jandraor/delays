functions {
  vector X_model(real time, vector y, array[] real params) {
    ...
    real E3_to_I1;
    real C_in;
    S_to_E = params[1]*y[1]*(y[3]+y[6]+y[7])/params[3];
    E1_to_E2 = 3*params[4]*y[2];
    I1_to_I2 = 3*params[5]*y[3];
    I2_to_I3 = 3*params[5]*y[6];
    I3_to_R = 3*params[5]*y[7];
    E2_to_E3 = 3*params[4]*y[8];
    E3_to_I1 = 3*params[4]*y[9];
