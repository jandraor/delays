functions {
  vector SE1I6R(real time, vector y, real[] params) {
    vector[10] dydt;
    real S_to_E;
    real E1_to_I1;
    real I1_to_I2;
    ...
    real I4_to_I5;
    real I5_to_I6;
    S_to_E = params[1]*y[1]*(y[3]+y[6]+y[7]+y[8]+y[9]+y[10])/10000;
    E1_to_I1 = 0.5*y[2];
    I1_to_I2 = 3*y[3];
...
transformed parameters{
  ...
  params[1] = beta;
  params[2] = rho;
  o = ode_rk45(SE1I6R, x0, t0, ts, params);
  x[1] =  o[1, 5]  - x0[5];
  for (i in 1:n_obs-1) {
