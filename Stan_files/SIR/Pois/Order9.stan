functions {
  vector SIR9(real time, vector y, real[] params) {
    vector[12] dydt;
    real S_to_I;
    real I2_to_I3;
    real S_to_C;
    ...
    real I8_to_I9;
    real I9_to_R;
    S_to_I = params[1]*y[1]*(y[2]+y[5]+y[6]+y[7]+y[8]+y[9]+y[10]+y[11]+y[12])/1000;
    I2_to_I3 = 2.25*y[5];
    S_to_C = S_to_I;
    I1_to_I2 = 2.25*y[2];
    I3_to_I4 = 2.25*y[6];
    ...
    dydt[11] = I7_to_I8-I8_to_I9;
    dydt[12] = I8_to_I9-I9_to_R;
    return dydt;
  }
}
data {
...
transformed parameters{
  ...
  x0[12] = I0;
  params[1] = beta;
  o = ode_rk45(SIR9, x0, t0, ts, params);
  x[1] =  o[1, 4]  - x0[4];
  for (i in 1:n_obs-1) {
